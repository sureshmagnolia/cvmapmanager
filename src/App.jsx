...
function App() {
  const [allocations, setAllocations] = useState(() => {
    const saved = localStorage.getItem('valuation_allocations_camp2_v3');
    return saved ? JSON.parse(saved) : initialAllocations;
  });
  const [examiners, setExaminers] = useState(() => {
    const saved = localStorage.getItem('valuation_examiners_camp2_v3');
  ...
  useEffect(() => {
    localStorage.setItem('valuation_allocations_camp2_v3', JSON.stringify(allocations));
    localStorage.setItem('valuation_examiners_camp2_v3', JSON.stringify(examiners));
